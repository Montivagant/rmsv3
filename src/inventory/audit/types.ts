...
// Legacy alias for backward compatibility
export interface CountsResponse extends AuditsResponse { data: InventoryCount[] }
...
// Legacy alias for backward compatibility
export interface CountItemQuery extends AuditItemQuery { showCountedOnly?: boolean; showNotCountedOnly?: boolean }
...
// Legacy alias for backward compatibility
export interface CreateCountRequest extends CreateAuditRequest { scope: CountScope }
...
export const AuditUtils = {
  ...
  validateCountScope(scope: CountScope): { isValid: boolean; errors: string[] } {
    return this.validateAuditScope(scope);
  }
};
