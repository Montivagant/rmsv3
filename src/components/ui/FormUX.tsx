...
export const AutoSaveIndicator: React.FC<AutoSaveIndicatorProps> = ({
  ...
  if (error) {
    return (
      <div className={cn('flex items-center text-sm text-red-600 dark:text-red-400', className)}>
  ...
  if (isSaving) {
    return (
      <div className={cn('flex items-center text-sm text-blue-600 dark:text-blue-400', className)}>
  ...
  if (lastSaved) {
    return (
      <div className={cn('flex items-center text-sm text-green-600 dark:text-green-400', className)}>
        <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="space-y-2">
              {shortcuts.map((shortcut, index) => (
                <div key={index} className="flex justify-between items-center">
                  ...
                  <kbd className="bg-gray-100 dark:bg-gray-700 text-xs px-2 py-1 rounded">
                    {[
