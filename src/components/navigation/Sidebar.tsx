...
import { navigationConfig, filterNavItemsByRole, getExpandedSections, saveExpandedSections } from '../../config/nav.config';
...
const NavGroup: React.FC<NavGroupProps> = ({
  ...
  if (!item.children || item.children.length === 0) {
    return <NavItemComponent item={item} collapsed={collapsed} depth={depth} />;
  }
